...
# python scripts/local.py --runs 5 -e experiments/forager-two-biome-small-sweep/ForagerTwoBiomeSmall/DQN-5-mlp.json --entry src/continuing_main.py --cpus 30
...
python scripts/local.py --runs 5 -e experiments/forager-two-biome-small-sweep/ForagerTwoBiomeSmall/DQN-15-mlp.json --entry src/continuing_main.py --cpus 30
