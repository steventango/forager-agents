...
python scripts/local.py --runs 5 -e experiments/forager-temperature/ForagerTemperature/Greedy.json --entry src/continuing_main.py --cpus 30
python scripts/local.py --runs 5 -e experiments/forager-temperature/ForagerTemperature/Random.json --entry src/continuing_main.py --cpus 30
